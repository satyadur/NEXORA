...
import { createCourseApi, getCategoriesApi } from "@/lib/api/course.api";
...
export default function CreateCoursePage() {
  ...
  const addSkill = () => {
    if (newSkill.trim() && !skills.includes(newSkill.trim())) {
      ...
      form.setValue("skillsGained", [...skills, newSkill.trim()]);
      setNewSkill("");
    }
  };
            ...
            <TabsContent value="details">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Add skills, tags, and other details
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  {/* Skills Gained */}
            ...
            <TabsContent value="instructors">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Assign instructors to this course
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <FormField
            ...
            <TabsContent value="fee">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Set course duration and fee structure
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-2 gap-6">
